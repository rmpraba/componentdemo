 ...
 function FnCreateRoot(page,root){  
  pagename=page;
  rootcard=root;  
 }

 function FnCreateElement(cardarr,page,roott){  
  //alert('coming')
        pagename=page;
        rootcard=roott;        
        ...
        for(var i=0;i<cardarr.element.length;i++)
          {         
            //alert(cardarr.element[i].inputtype);
          ...
          // {
            ...
            document.querySelector('component-card').setElement(card);
          // }   
         }
